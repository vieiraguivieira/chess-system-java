...
public class ChessMatch {
	...
	public ChessMatch() {
		...
		check = false; // não é necessário, por padrão é false
		initialSetup();
	}
	...
	public ChessPiece replacePromotedPiece(String type) {
		...
		if(!type.equals("B") && !type.equals("N") && !type.equals("R") && !type.equals("Q") && !type.equals("b") && !type.equals("n")&& !type.equals("r")&& !type.equals("q")) {
